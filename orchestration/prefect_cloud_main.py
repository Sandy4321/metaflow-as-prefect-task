...
@task
def cleanup(metaflow_run_results: list, directory : str):
    """
    Cleanup the folder by deleting the temp directory hosting the cloned
    Flow repo
...
mf_flow = MetaflowShellTask(
    ...
    repo_name=os.getenv('METAFLOW_REPO_NAME'),
    clone_folder=os.getenv('METAFLOW_LOCAL_CLONE_FOLDER'),
